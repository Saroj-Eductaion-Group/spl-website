...
import { CheckCircle, XCircle, Users, FileText, X } from 'lucide-react'
          ...
          <div className="bg-white rounded-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center p-6 border-b sticky top-0 bg-white">
              <div>
                ...
                <p className="text-sm text-gray-500">{viewTeam.registrationId} • {viewTeam.schoolCollege}</p>
              </div>
            ...
            <div className="p-6 space-y-6">
              ...
              {viewTeam.status === 'PENDING' && (
                <div className="flex gap-3 pt-2 border-t">
                  ...
                  <button onClick={() => updateStatus(viewTeam.id, 'REJECTED')} className="flex-1 bg-red-500 hover:bg-red-600 text-white font-semibold py-2 rounded-lg flex items-center justify-center gap-2">
