      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col items-center justify-center p-16 bg-[#002366]">
        ...
        <div className="relative z-10 text-center max-w-sm">
          <div className="w-20 h-20 bg-[#ffd700]/10 border border-[#ffd700]/20 flex items-center justify-center mx-auto mb-8">
            <span className="material-symbols-outlined text-[#ffd700]" style={{ fontSize: '40px' }}>shield_person</span>
          </div>
          <h1 className="font-headline font-black text-5xl italic uppercase tracking-tighter text-white mb-3">
            Coordinator <span className="text-[#ffd700]">Portal</span>
          </h1>
          <p className="text-white/60 text-sm mb-12 font-body">District Coordinator Access — SPL U19</p>

          <div className="space-y-4 text-left">
            {[
              { icon: 'groups',          text: 'View & manage district teams'              },
              { icon: 'fact_check',      text: 'Verify documents & approve registrations' },
              { icon: 'scoreboard',      text: 'Upload match results & assign players'     },
            ].map(({ icon, text }) => (
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center px-6 py-12 bg-[#0b0b0f]">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-10">
            <span className="font-headline font-black text-3xl italic uppercase text-[#ffd700]">SPL Coordinator</span>
          </div>

          <div className="mb-8">
            <div className="w-12 h-12 bg-[#ffd700]/10 border border-[#ffd700]/20 flex items-center justify-center mb-6">
              <span className="material-symbols-outlined text-[#ffd700]" style={{ fontSize: '24px' }}>shield_person</span>
            </div>
            <h2 className="font-headline font-black text-4xl italic uppercase tracking-tighter text-[#e4e1e9]">Coordinator Login</h2>
            <p className="text-[#c4c6d0] text-sm mt-1 font-body">District Coordinator Access Portal</p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-[#444650]/20 flex flex-col gap-3 text-center">
            <Link href="/admin/login" className="text-sm font-body text-[#c4c6d0]/60 hover:text-[#ffd700] transition-colors">
              Admin? <span className="text-[#ffd700] font-semibold">Login here →</span>
            </Link>
